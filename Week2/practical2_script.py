...
town_handle = ax.plot(towns[towns['town_city'] == 0].geometry.x, towns[towns['town_city'] == 0].geometry.y, 's', color='0', ms=6, transform=myCRS)

city_handle = ax.plot(towns[towns['town_city'] == 1].geometry.x, towns[towns['town_city'] == 1].geometry.y, 's', color='r', ms=6, transform=myCRS)
...
myFig.savefig('map6.png', bbox_inches='tight', dpi=300)
